...
const validation = {
  ...
  validateCardExpiry: function(month, year) {
    ...
    if (!year) {
      var assign;
      (assign = validation.cardExpiryVal(month)),
        (month = assign.month),
        (year = assign.year);
    }
  ...
  cardType: function(num) {
    ...
    return (
      cardFormatUtils.__guard__(cardFormatUtils.cardFromNumber(num), function(
        x
      ) {
        return x.type;
      }) || null
...
const format = {
  ...
  validateCardName: validation.validateCardName,
...
Vue.directive('cardFormat', {
  bind: function bind(el, binding, vnode) {
    ...
    if (
      method == 'formatCardNumber' &&
      typeof vnode.context.cardBrand !== 'undefined'
    ) {
